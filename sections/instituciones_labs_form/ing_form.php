...
<body>
    ...
    <section class="btns_labs center">
        ...
        <a class="btn btn-ing" href="#">3. Capacidades de ingeniería</a>
    ...
    <!---------------------------------------------------------------------------------------------------------------------------------------------->
    <div class="content">
        <h5 class="bold">3. Capacidades de desarrollo tecnológico.</h5>
        ...
        <form method="POST">
            ...
            <h6>3. Nombre del proyecto o línea de investigación.</h6>
