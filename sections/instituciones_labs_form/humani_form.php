...
<body>
    ...
    <section class="header_banner">
        <img style="max-width: 100%;" src="../../img/inventarioTecnologico/humanidades.png">
    </section>
    ...
    <section class="btns_labs center">
        ...
        <a class="btn btn-humani" href="#">4. Capacidades en humanidades</a>
    </section>
    <!---------------------------------------------------------------------------------------------------------------------------------------------->
    <!-----------------------------------------------------FORMULARIO DE REGISTRO------------------------------------------------------------------->
    <!---------------------------------------------------------------------------------------------------------------------------------------------->
    <div class="content">
        <h5 class="bold">4. Capacidades de investigación humanística.</h5>
                ...
                <div class="collapsible-body">
                    <span>
                        ...
                        <ol>
                            ...
                            <li>Registra tu información por cada proyecto o línea de investigación científica que
                                desees inventariar.</li>
                            <li>Realiza el envío de tu información con tu clave institucional.</li>
                            <li>Repite estos pasos por cada proyecto o línea de investigación científica que desees
                                inventariar.</li>
                        </ol>
                    </span>
                </div>
        ...
        <form method="POST">
            ...
            <h6>2. Nombre del proyecto o línea de investigación.</h6>
            <input type="text" name="nombreLab" required>

            <h6>3. Área del conocimiento a la que pertenece el proyecto o línea de investigación.</h6>
            <div class="input-field col s12">
                <select name="areaConocimientoLab" required>
                    <option value="" disabled selected>Selecciona un área de conocimiento</option>
                    <?php include "php/fill/areas_humanidades.php"; ?>
                </select>
            </div>

            <h6>4. Tipo de conocimientos, datos o información que genera el proyecto o línea de investigación.</h6>
            <textarea name="equipamientoLab" required></textarea>

            <h6>5. Sectores Industriales a los que puede dar servicios el proyecto o línea de investigación.</h6>
            ...
            <h6>6. Servicios a la industria puede brindar el proyecto o línea de investigación.</h6>
            <textarea name="serviciosLab" required></textarea>



            <h6>7. Nombre completo del responsable del proyecto o línea de investigación.</h6>
            ...
            <h6>9. Teléfono de contacto del responsable del proyecto o línea de investigación.</h6>
            ...
            <div class="submit center">
                <input type="submit" value="Enviar" class="btn" name="submitHumanidadesLab" onclick="return ConfirmSubmit()">
            </div>
            <?php include "php/envio_humanidades.php"; ?>
        </form>
